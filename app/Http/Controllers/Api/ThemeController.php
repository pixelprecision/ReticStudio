...
class ThemeController extends Controller {
	 ...
	 */
	public function getLayoutForPageType(Request $request) {
		$pageType = $request->input('page_type', 'default');
		...
		$layout = $theme->getLayoutForPageType($pageType);
		
		if (!$layout) {
			return response()->json(['error' => 'No layout configuration found for this page type'], 404);
		}

// resources/js/admin/src/components/pageRenderer/storeComponents/ProductListComponent.jsx
...
const ProductListComponent = ({
  ...
  if (loading && products.length === 0) {
    return (
      <div id={componentId} className={`product-list-component my-8 ${extraClasses}`}>
      ...
      <div className="space-y-6">
        {products.map((product) => {
          ...
          return (
            <div 
              key={product.id} 
              className="product-item bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
            >
              <div className="flex flex-col md:flex-row">
                ...
                <div className={`p-4 md:p-6 ${showImage ? 'md:w-3/4' : 'w-full'}`}>
                  <div className="flex flex-col md:flex-row md:justify-between">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Link 
                        ...
                        className="mt-2 text-blue-600 hover:text-blue-800 text-center text-sm"
                      >
                        View Details
                      </Link>
                    </div>
